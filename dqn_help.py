...
class DQNAgent:
    ...
    def __init__(self, env, network, buffer, epsilon=0.05, batch_size=32, reward_threshold=295):
        ...
        self.window = 100
        self.reward_threshold = reward_threshold  # Avg reward before CartPole is "solved"
        self.initialize()
                ...
                if done:
                    ...
                    if mean_rewards >= self.reward_threshold:
                        ...
                        print('\nEnvironment solved in {} episodes!'.format(
                            ep))
                        break
        return self.training_rewards, self.mean_training_rewards
